...
user getUser(); authorization get_registr(); void findUser(FILE* users, user _user, authorization odd, int i, int& admin, user& now);
...
void findUser(FILE * users, user _user, authorization odd, int i, int& admin, user & now)
{
	system("cls");
